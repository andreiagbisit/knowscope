  ...
  return (
    <>
      <div className='md:px-36 px-8 pt-10'>
        ...
        <table className='md:table-auto table-fixed w-full overflow-hidden border border-zinc-500/20 mt-10'>
          <thead className='text-zinc-900 border-b border-zinc-500/20 text-sm text-left max-sm:hidden'>
            <tr>
                ...
                <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    <Line strokeWidth={2} percent={progressArray[index] ? (progressArray[index].lectureCompleted * 100) / 
                          progressArray[index].totalLectures : 0} className='bg-zinc-300 rounded-full' />
                  </div>
                </td>
