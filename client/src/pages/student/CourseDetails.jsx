...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left isolate'>
        <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-linear-to-b from-teal-100/70'></div>

        {/* LEFT COLUMN */}
        <div className='max-w-xl z-10 text-zinc-500'>
          ...
          <p className='text-sm'>
            Course by <span className='text-green-600 underline'>{courseData.educator.name}</span>
          </p>
        ...
        <div className='max-w-(--course-card) z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
              ...
              <div className='flex gap-3 items-center pt-2'>
                ...
                <p className='md:text-lg text-zinc-500 line-through'>
              ...
              <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-zinc-500'>
              ...
              <div className='pt-6'>
                <p className='md:text-xl text-lg font-medium text-zinc-800'>What's in the course?</p>

                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-zinc-500'>
